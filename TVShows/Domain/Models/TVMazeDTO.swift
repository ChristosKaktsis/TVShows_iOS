...
//  TvShow
//
//  Created by vnastos on 19/1/23.
//

import Foundation

// MARK: - TVMazeDTOElement
struct TVMazeDTOElement: Codable, Equatable {
    static func == (lhs: TVMazeDTOElement, rhs: TVMazeDTOElement) -> Bool {
...
typealias TVMazeDTO = [TVMazeDTOElement]
